...
class Video_V1(RedisSpider):
    ...
    def parse_detail(self,response):
        ...
        item["category"] = {'channel': item['channel'], 'child_channel': '', 'keyword': [], 'region': '', 'tag': item['tag'],
                            'topic': []}

        item["author"] = {'name': name, 'avatar': '', 'type': '0', 'fans_count': '', 'scan_count': '',
                          'collect_count': '', 'is_delete': '0', 'gmt_create': item['janesi_time'],
                          'gmt_modified': item['janesi_time'], 'platform': 'pearvideo'}
